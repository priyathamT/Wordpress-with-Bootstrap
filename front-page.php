...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <style>
        .showcase{
            background:url(<?php echo get_theme_mod('showcase_image', get_bloginfo('template_url').'/img/showcase-image.jpg'); ?>) no-repeat center center;
  ...
  <body>
    ...
    <div class="blog-masthead">
      ...
      <div class="container">
        ...
        <p><?php echo get_theme_mod('showcase_text','Custom Text Here'); ?></p>
